...
- **Compatibility first:** same operations, same request/response *shape* where
...
```json
{
  ...
  "assets": [
    { "composition": "...", "layer": "...", "type": "script|data|image|audio|video",
      "src": "<file reference>", "text": "<literal, for data>" }
  ]
}
```
