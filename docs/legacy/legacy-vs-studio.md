...
| Global daily upload cap = 3                                                              | Cap model _(OPEN DECISION — likely per-YouTube-target)_                                                       | [jobs.md](../domain/jobs.md)                       |
| No department field                                                                      | `departmentId` required                                                                                       | ADR-0011                                           |
...
| Privacy hard-coded `private`                    | Default `private`, optional `unlisted`/`public` _(OPEN DECISION)_ | [youtube.md](../integrations/youtube.md) |
