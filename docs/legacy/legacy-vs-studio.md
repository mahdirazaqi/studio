...
| `POST /jobs/:id/upload` (unauth) → 200, fire-and-forget | `POST /api/v1/worker/jobs/:id/upload` (no credential required — matches the real Worker, ADR-0043) → 200, synchronous artifact generation, no external delivery (ADR-0041) | ADR-0004, ADR-0039, ADR-0041, ADR-0043         |
