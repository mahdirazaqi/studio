...
| **YouTube (implemented, Phase 9)**        |                                 |                                          |                                   |                                                                                                                                                                                                               |
| Connect / disconnect a channel            | ⬛                              | 🟨                                       | ✅                                | `youtube:manage`, same `MANAGER+` floor as `template:manage`. Department-scoped; ADMIN may target any department.                                                                                             |
| View connected channels                   | ⬛                              | 🟨                                       | ✅                                | Same capability as above — no separate view-only floor.                                                                                                                                                       |
| Pick a channel for a Template             | ⬛ (matches template:manage)    | 🟨                                       | ✅                                | Gated by `template:manage`, not `youtube:manage` — authoring a Template, not managing Targets.                                                                                                                |
