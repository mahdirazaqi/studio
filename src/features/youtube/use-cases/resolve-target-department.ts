...
/**
 * Mirrors `features/templates/use-cases/resolve-target-department.ts` and
 * `features/files/use-cases/upload-file.ts`'s helper of the same shape — each
 * feature keeps its own copy rather than importing another feature's
 * use-case module (docs/architecture/project-structure.md §3).
 */
